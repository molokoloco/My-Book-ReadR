...
$("<div/>").css({width:"100px",position:"absolute",right:"-100px"}).appendTo(i);var u=0.25,C=0,W=0,X=null,Y=null,Db=function(){u=0.5;W=C=0;Y=X=null},Ta=function(a,b){a.preventDefault();X&&clearTimeout(X);X=setTimeout(Db,!W||W==b?2400:0);Y||(Y=new Date);var c=(new Date).getSeconds()-Y.getSeconds();10<C&&3>=c||18<C||20==u?u=15:4<C&&2>=c?u=1.8:2<C&&(u=1.2);W=b;C++;0<b?A(-u):A(u);return!1},D=null,Z=null,Eb=function(){clearInterval(Z);Z=null;ta();rb.toggleClass("fade",y()<e());d.removeClass("highlight");
